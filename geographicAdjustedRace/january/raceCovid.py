...
data.loc['New York'] = data.loc['New York'].astype(float)+data.loc['New York City'].astype(float)
# Drop NYC
...
actDeath = pd.Series(data = [28956,2161,9185,34612,487,133216,8944], index = actIndex)
actCase = pd.Series(data = [1874494,118246,314719,1094735,33187,4957823,521125], index = actIndex)
