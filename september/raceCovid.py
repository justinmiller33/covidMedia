...
actDeath = pd.Series(data = [19810,944,5917,25037,247,62395,5082], index = actIndex)
actCase = pd.Series(data = [775498,30864,89206,497797,11616,1131513,119873], index = actIndex)
